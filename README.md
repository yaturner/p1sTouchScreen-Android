...
-- verified live), Filament/AMS (4-slot AMS status + load/unload --
verified live), Control (jog/home/extrude/fans/light/temps), Settings.

**Status: active work in progress**, not yet fully polished, but every
screen is built and verified against a real printer -- MQTT (live
telemetry, all Control commands), FTP (file listing, thumbnails,
starting a print), the camera stream, and AMS status/load/unload all
